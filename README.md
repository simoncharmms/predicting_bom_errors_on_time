...
results. The agent layer is documented in [AGENT.md](AGENT.md), and its working
principle is shown on real data in the
[demo dashboard](https://simoncharmms.github.io/predicting_bom_errors_on_time/)
(source in [`docs/`](docs/), data snapshot regenerated by `export_demo.py`).
